...
export function LiveToolPanel() {
  const { tools, supported } = useLiveTools();
  ...
  return (
    <section aria-label="Live tools" className="px-3 pt-5">
      ...
      <p className="px-2 pb-2 text-[11px] leading-4 text-ink-muted">From <code className="font-mono">getTools()</code>, refreshed on <code className="font-mono">toolchange</code>.</p>
      {!supported ? (
